...
Most of these come down to network reality or how uniprot serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

uniprot rate-limits like any public site. uniprot already paces
...
Where a surface is gated, uniprot reads a cookie or token you supply
...
`uniprot`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what uniprot actually did
